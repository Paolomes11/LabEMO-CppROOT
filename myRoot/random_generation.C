// clang-format off
// R__LOAD_LIBRARY(libParticle.so)
// R__LOAD_LIBRARY(libParticleType.so)
// R__LOAD_LIBRARY(libResonanceType.so)
    gSystem->Load("myRoot/libParticleType.so");
    gSystem->Load("myRoot/libResonanceType.so");
    gSystem->Load("myRoot/libParticle.so");
// clang-format on
