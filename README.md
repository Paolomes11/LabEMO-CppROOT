...
The tests for the histograms have all been set with a percentage of 99% but, because of the mere number of tests related to probability, it is still rather common to see one or maximum two of the 32 tests fail.